                    ...
                    <div class="mx-auto p-6 pb-1 border bg-white rounded-md shadow-dashboard">
                        <div class="flex flex-wrap items-center justify-between mb-1 -m-2">
                            <div class="w-auto p-2">
                                <h2 class="text-lg font-semibold text-coolGray-900">Rata-rata Departemen</h2>
                            </div>
                            <div class="w-auto p-2">
                                <a href="#" class="text-sm text-red-700 hover:text-red-600 font-semibold">See all</a>
                            </div>
                        </div>
                                ...
                                <div class="flex flex-wrap items-center justify-between py-4 -m-2">
                                    <div class="w-auto p-2">
                                        <div class="flex flex-wrap items-center -m-2">
                                            ...
                                            <div class="w-auto p-2">
                                                <h2 class="text-base font-medium text-coolGray-900"> {{$rataDepartement->nama_departement}} </h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="w-auto p-2">
                                        <p class="text-lg text-coolGray-500 font-medium">{{number_format($rataDepartement->rata_nilai_departement,2)}}</p>
                                    </div>
                                </div>
                            </div>
                            @endforeach
