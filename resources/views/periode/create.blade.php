        ...
        <div class="p-8 bg-white">
            ...
            <form action="{{ route('periode.store') }}" method="POST" class="gap-6 grid">
                ...
                <div class="gap-2 grid">
                    ...
                    <input type="text" id="nama_periode" name="nama_periode" required placeholder="Masukan Nama Periode"
                        class="p-4 bg-[#E5E5E5]  rounded-2xl  text-sm w-full outline-0">
                </div>
                <div class="gap-2 grid">
                    <div class="font-semibold">Tahun</div>
                    <input type="text" id="tahun" name="tahun" required placeholder="Masukan Tahun"
                        class="p-4 bg-[#E5E5E5]  rounded-2xl  text-sm w-full outline-0">
                </div>
                <button type="submit"
