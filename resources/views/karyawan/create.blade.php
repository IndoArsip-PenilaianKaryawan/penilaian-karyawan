...
<body>
    ...
    <div class="px-4 py-8 xl:ml-80 bg-[#F5F6F7] min-h-screen">
        <div class="p-8 bg-white">
            <h1 class="font-semibold text-xl text-center mb-2">Tambah Karyawan</h1>
            <form action="{{ route('karyawan.store') }}" method="POST" class="gap-6 grid">
                @csrf
                <div class="gap-2 grid">
                    <div class="font-semibold">Nama</div>
                    <input type="text" id="nama" name="nama" required placeholder="Masukan Nama" class="p-4 bg-[#E5E5E5]  rounded-2xl  text-sm w-full outline-0">
                </div>
                <div class="gap-2 grid">
                    <div class="font-semibold">No Pegawai</div>
                    <input type="text" id="no_pegawai" name="no_pegawai" required placeholder="Masukan No Pegawai" class="p-4 bg-[#E5E5E5]  rounded-2xl  text-sm w-full outline-0">
                </div>
                ...
                <div class="gap-2 grid">
                    ...
                    <div class="p-4 bg-[#E5E5E5]  rounded-2xl  text-sm w-full outline-0">
                        <select id="id_departement" name="id_departement" required placeholder="Masukan Departement" class="bg-transparent w-full outline-0" onchange=getBidangs()>
                ...
                <div class="gap-2 flex items-center">
                    ...
                    <input type="checkbox" id="is_penilai" name="is_penilai" class="h-4 w-4 text-[#9F2D2D] border-[#9F2D2D] rounded-full focus:ring-[#9F2D2D]">
                </div>
