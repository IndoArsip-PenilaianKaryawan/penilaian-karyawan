                ...
                <div class=" flex justify-start md:w-1/3 ">
                    <div class=" p-2 md:p-4 bg-[#E5E5E5] rounded-l-2xl flex items-center text-xs md:text-sm w-full">
                        ...
                        <input id="searchInput" class="bg-transparent outline-0 w-10/12" type="text"
                            placeholder="Cari Karyawan..." name="search" value="{{ request('search') }}">
                    </div>
                    <button type="submit"
                        class="py-2 md:py-4 px-6 bg-[#9F2D2D] text-white rounded-r-2xl text-xs md:text-sm"">
                        Cari
                    </button>
        </form>
    </div>
                ...
                @foreach ($karyawans as $karyawan)
                    <tr>
                        ...
                        <td class="text-xs md:text-sm">
                            {{ $karyawan->bidang ? $karyawan->bidang->nama_bidang : 'Tidak ada' }}</td>
                        ...
                        <td class="text-xs md:text-sm">
                            {{ $karyawan->approval2 ? $karyawan->approval2->nama : 'Tidak ada' }}</td>
                        <td class="text-xs md:text-sm">
