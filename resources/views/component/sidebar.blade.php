...
<body>
    ...
    <!-- component desktop -->
    <aside
        class=" bg-white -translate-x-80 fixed inset-0 z-50 my-4 ml-4 h-[calc(100vh-32px)] w-72 rounded-xl transition-transform duration-300 xl:translate-x-0">
        ...
        <div class="m-4">
            <ul class="mb-4 flex flex-col gap-1">
                <li>
                    <a href="/admin">
                        <button id="dashboard-link" class="flex items-center gap-6 w-full p-4 rounded-2xl"
                            type="button">
                            <span class="text-xs">
                ...
                <li>
                    <a href="/kompetensi">
                        <button id="kompetensi-link" class="flex items-center gap-6 w-full p-4 rounded-2xl"
                            type="button">
                            <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <ul class="mb-4 flex flex-col gap-1">
                <li class="mx-3.5 mt-4 mb-2">
                    <p
                        class="block antialiased font-sans text-sm leading-normal text-bold font-black uppercase opacity-75">
                        auth pages</p>
                </li>
                <li>
    ...
    <!-- Sidebar mobile -->
    <div class="md:hidden absolute bg-white w-72 h-screen inset-0 z-50 overflow-y-auto transition-transform transform -translate-x-full ease-in-out duration-300"
        id="sidebar">
        <a class="flex items-center gap-4 py-6 px-8" href="#/">
        ...
        <div class="m-4">
            <ul class="mb-4 flex flex-col gap-1">
                ...
                <li>
                    <a href="/rekap">
                        <button id="rekap-link" class="flex items-center gap-6 w-full p-4 rounded-2xl"
                            type="button">
                            <span class="text-xs">
                                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1" stroke="currentColor">
                ...
                <li>
                    <a href="/cabang">
                        <button id="cabang-link" class="flex items-center gap-6 w-full p-4 rounded-2xl"
                            type="button">
                            <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <li>
                    <a href="/periode">
                        <button id="periode-link" class="flex items-center gap-6 w-full p-4 rounded-2xl"
                            type="button">
                            <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
