        ...
        <div class="p-4 xl:ml-80">
            ...
            <div class="flex flex-wrap gap-4">
                ...
                <div class="w-full max-w-sm p-8 bg-[#9F2D2D] border transition relative duration-300 cursor-pointer hover:translate-y-[3px] border-none outline-none hover:shadow-[0_-8px_0px_0px_rgb(0,0,50)] rounded-2xl shadow ">
                    <a href="{{route('dashboard_penilai.periksa')}}">
                        <h5 class="mb-2 text-xl font-normal tracking-tight text-white opacity-60">Rata-rata bidang {{$rata->nama_bidang}}</h5>
                    </a>
                    <div class="flex justify-between items-start">
                        <p class="text-6xl mb-3 font-semibold text-white">{{number_format($rata->rata_nilai_bidang,2)}}</p>
                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="56" height="56" rx="28" fill="#202020" />
                            <path d="M24.6506 26.3681C23.7855 25.5078 23.25 24.3164 23.25 23C23.25 21.6836 23.7855 20.4922 24.6506 19.6319C24.1526 19.3873 23.5923 19.25 23 19.25C20.9289 19.25 19.25 20.9289 19.25 23C19.25 25.0711 20.9289 26.75 23 26.75C23.5923 26.75 24.1526 26.6127 24.6506 26.3681Z" fill="#FB5151" />
                            <path d="M24.25 23C24.25 20.9289 25.9289 19.25 28 19.25C30.0711 19.25 31.75 20.9289 31.75 23C31.75 25.0711 30.0711 26.75 28 26.75C25.9289 26.75 24.25 25.0711 24.25 23Z" fill="#FB5151" />
            ...
            <h1 class="text-3xl my-8 font-semibold mt-6">Karyawan Inkompeten</h1>
            <table>
                <thead>
                    <tr>
            ...
            @endif
            @if ($totalKompeten > 0)
            <h1 class="text-2xl my-4 font-semibold mt-6">Karyawan Kompeten</h1>
            <table>
                <thead>
                    <tr>
                        <th>Nomor Karyawan</th>
                    ...
                    <div class="mx-auto p-6 pb-1 border bg-white rounded-md shadow-dashboard">
                        ...
                        <div class="flex flex-wrap">
                                ...
                                <div class="flex flex-wrap items-center justify-between py-4 -m-2">
                                    <div class="w-auto p-2">
                                        <div class="flex flex-wrap items-center -m-2">
                                            ...
                                            <div class="w-auto p-2">
                                                <h2 class="text-base font-medium text-coolGray-900"> {{$karyawanKompeten->nama}} </h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="w-auto p-2">
                                        <p class="text-lg text-coolGray-500 font-medium">{{number_format($karyawanKompeten->average,2)}}</p>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="flex flex-col">
                                <h5 class="font-semibold mt-4">Karyawan Inkompeten</h5>
                                    ...
                                    <div class="flex flex-wrap items-center justify-between py-4 -m-2">
                                        <div class="w-auto p-2">
                                            <div class="flex flex-wrap items-center -m-2">
                                                ...
                                                <div class="w-auto p-2">
                                                    <h2 class="text-base font-medium text-coolGray-900"> {{$inkompetenKaryawan->nama}} </h2>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="w-auto p-2">
                                            <p class="text-lg text-coolGray-500 font-medium">{{number_format($inkompetenKaryawan->average,2)}}</p>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
            ...
            @if ($totalInkompeten > 0)
            <h1 class="text-3xl my-8 font-semibold mt-6">Inkompeten Karyawan</h1>
            <table>
                <thead>
                    <tr>
                        <th>Nomor Karyawan</th>
                ...
                <tbody>
                    @foreach ($inkompetenKaryawanManager as $karyawan)
                    <tr>
                        <td>{{ $karyawan->no_pegawai}}</td>
                        <td>{{ $karyawan->nama }}</td>
                        <td> {{number_format($karyawan->average,1) }}</td>
